       ...
       <!-- <p>上传历史</p>-->
        ...
        <div>
            <el-table :data="page.dataList | forListTime" 
                ...
                <el-table-column prop="Reporttime" label="时间" width="200px" align="center"></el-table-column>

                <el-table-column align="center" style="margin-left:20px;" label="处理结果">
                <!-- <template #header>
    ...
    export default{
        ...
        methods:{
            ...
            getPageList(i){
                ...
                this.$axios({
                    method:"get",
                    url: "http://127.0.0.1:8000/search_msg/?page="+this.page.pageNo+"&page_size="+this.page.pageSize,
