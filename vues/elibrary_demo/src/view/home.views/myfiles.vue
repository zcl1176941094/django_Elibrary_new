            ...
            <el-table :data="page.dataList" 
                ...
                <!-- <template #header>
                    ...
                    <template #default="scope" margin-right="20px">
                        ...
                        <el-button size="small" @click="handlPreview(scope.$index, scope.row)" v-if="scope.row.isvalid==false" type="danger" plain>违规</el-button>
   <!--     暂时未实现   <el-button
                            size="small"
                            type="danger"
    ...
    export default{
        ...
        methods:{
            ...
            getPageList(i){
                ...
                this.$axios({
                    method:"get",
                    url: "http://127.0.0.1:8000/posthistory/?page="+this.page.pageNo+"&page_size="+this.page.pageSize,
