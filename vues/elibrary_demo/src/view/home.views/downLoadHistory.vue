       ...
       <!-- <p>下载历史</p>-->
        ...
        <div>
            <el-table :data="page.dataList | forListTime" 
                ...
                <el-table-column prop="ave_score" label="评分" width="80px"   margin-left="50px"></el-table-column>
    ...
    export default{
        ...
        methods:{
            ...
            getPageList(i){
                ...
                this.$axios({
                    method:"get",
                    url: "http://127.0.0.1:8000/downloads/?page="+this.page.pageNo+"&page_size="+this.page.pageSize,
