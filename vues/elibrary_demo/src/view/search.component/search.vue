...
<div>
    <div>
        ...
        <el-form-item label-width="1000px">
            <el-input v-model="input.name" size=medium placeholder="请输入查询书名"></el-input>
        </el-form-item>

        <el-form-item label-width="200px" >
            <el-select v-model="input.category" placeholder="种类" size=small>
...
<!--------------------------------------------------------->
    <el-row style="height: auto;align:center;margin:auto;">
